...
a = plt.plot(REGULARIZATION, [x["train"] for x in results])
a = plt.plot(REGULARIZATION, [x["dev"] for x in results])
a = plt.xscale('log')
a = plt.xlabel("regularization")
a = plt.ylabel("accuracy")
a = plt.legend(['train', 'dev'], loc='upper left')
# plt.savefig("reg_acc_0506.png")
plt.savefig("reg_acc_dim10_c7.png")
#plt.show()
print('done')
